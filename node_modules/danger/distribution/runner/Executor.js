...
var Executor = (function () {
    ...
    Executor.prototype.handleResultsPostingToPlatform = function (results) {
        return __awaiter(this, void 0, void 0, function () {
            var fails, warnings, messages, markdowns, failureCount, messageCount, failed, successPosting, s, are, comment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fails = results.fails, warnings = results.warnings, messages = results.messages, markdowns = results.markdowns;
                        ...
                        return [4 /*yield*/, this.platform.updateStatus(!failed, messageForResults(results))];
                    case 1:
