...
var GitHubAPI = (function () {
    ...
    GitHubAPI.prototype.getExternalAPI = function () {
        var baseUrl = process.env["DANGER_GITHUB_API_BASE_URL"] || null;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        allComments = _a.sent();
                        dangerComment = find(allComments, function (comment) { return (!userID || comment.user.id === userID) && v.includes(comment.body, githubIssueTemplate_1.dangerSignaturePostfix); });
    ...
    GitHubAPI.prototype.getPullRequestCommits = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var repo, prID, ret, getNextPageFromLinkHeader, page, requestUrl, response, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        requestUrl = "repos/" + repo + "/pulls/" + prID + "/commits" + (page > 0 ? "?page=" + page : "");
    ...
    GitHubAPI.prototype.updateStatus = function (passed, message) {
        return __awaiter(this, void 0, void 0, function () {
