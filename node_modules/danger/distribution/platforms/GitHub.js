...
var GitHub = (function () {
     ...
     * then return true.
     */
    GitHub.prototype.updateStatus = function (passed, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.api.updateStatus(passed, message)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    GitHub.prototype.getPlatformDSLRepresentation = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pr, issue, commits, reviews, requested_reviewers, externalAPI, thisPR;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        externalAPI = this.api.getExternalAPI();
